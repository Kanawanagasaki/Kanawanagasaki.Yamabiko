...
public class KeyHashHelper_Tests
{
    ...
    public void HelloHash()
    {
        ...
        var clientHelloRecord = PlainTextRecord.Parse(clientHelloData, 0, 0, ref clientHelloOffset);
        var clientHelloFragment = HandshakeFragment.Parse(clientHelloRecord.Buffer);

        int serverHelloOffset = 0;
        var serverHelloRecord = PlainTextRecord.Parse(serverHelloData, 0, 0, ref serverHelloOffset);
